from woniutest.tools.util import DBUtil
from woniutest_bak.tools.basic import Basic
import os
...
class TestReport:
    ...
    def __init__(self, app_name):
        ...
        self.logger = Basic.get_logger('test_report')
...
if __name__ == '__main__':
    ...
    # result_info = {'version':'v2.0', 'module':'login', 'type':'ui',
