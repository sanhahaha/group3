...
class FileUtil:
    ...
    def get_test_info(cls, path, section, option):
        ...
        case_sheet_content = workbook.sheet_by_name(params['case_sheet_name']) #版本页
        ...
        for i in range(params['start_row'], params['end_row']):
            ...
            temp = str(data).split('\n')    #在excel中写参数时一定要 每一行写一个；是以换行符分割的
            di = {}
...
if __name__ == '__main__':
    pass
    # print(FileUtil.get_test_info('..\\conf\\test_info.ini', 'login', 'login_api'))